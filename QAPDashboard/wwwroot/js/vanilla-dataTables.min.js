...
(function (m, q) {
    ...
    var q = window,
        ...
        A = {
            ...
            header: !0,
            footer: !1,
            labels: { placeholder: "Search by Run Status...", perPage: "{select} entries per page", noRows: "No entries found", info: "Showing {start} to {end} of {rows} entries" },
        ...
        F = function (T, U, V) {
            if (B(T)) for (var W in T) Object.prototype.hasOwnProperty.call(T, W) && U.call(V, T[W], W);
        ...
        N = function (T) {
            ...
            T.data &&
                ...
                U && (null !== this.table.tHead && this.table.removeChild(this.table.tHead), this.table.appendChild(U)),
                V && (this.table.tBodies.length && this.table.removeChild(this.table.tBodies[0]), this.table.appendChild(V));
        },
        O = function (T, U) {
            var V = !1;
            return (
    ...
    (P.prototype.swap = function (T) {
        ...
        (P.prototype.order = function (T) {
            ...
            F(T, function (ba, ca) {
                (Y = aa.headings[ba]),
                    ...
                    (U.sortable = Z),
                    _[0].push(U),
                    0 > aa.hiddenColumns.indexOf(ba) && ((V = Y.cloneNode(!0)), (V.originalCellIndex = ca), (V.sortable = Z), _[1].push(V));
            }),
                F(aa.data, function (ba, ca) {
                    (W = ba.cloneNode()),
                        (X = ba.cloneNode()),
                        (W.dataIndex = X.dataIndex = ca),
                        null !== ba.searchIndex && void 0 !== ba.searchIndex && (W.searchIndex = X.searchIndex = ba.searchIndex),
                        F(T, function (da) {
        ...
        (P.prototype.add = function (T) {
            ...
            return this.dt.headings.length
                ? void (this.dt.hiddenHeader ? (W.innerHTML = "") : T.heading.nodeName ? W.appendChild(T.heading) : (W.innerHTML = T.heading),
                    this.dt.headings.push(W),
                    F(this.dt.data, function (X, Y) {
                        T.data[Y] &&
                            ((V = document.createElement("td")), T.data[Y].nodeName ? V.appendChild(T.data[Y]) : (V.innerHTML = T.data[Y]), (V.data = V.innerHTML), T.render && (V.innerHTML = T.render.call(U, V.data, V, X)), X.appendChild(V));
                    }),
                    T.type && W.setAttribute("data-type", T.type),
                    T.format && W.setAttribute("data-format", T.format),
                    T.hasOwnProperty("sortable") && ((W.sortable = T.sortable), W.setAttribute("data-sortable", !0 === T.sortable ? "true" : "false")),
                    this.rebuild(),
        ...
        (P.prototype.sort = function (T, U, V) {
            ...
            var ca, da;
            K.contains(ba, "asc") || "asc" == U ? ((ca = L(Z, -1)), (da = L($, -1)), (X = "descending"), K.remove(ba, "asc"), K.add(ba, "desc")) : ((ca = L($, 1)), (da = L(Z, 1)), (X = "ascending"), K.remove(ba, "desc"), K.add(ba, "asc")),
                W.lastTh && ba != W.lastTh && (K.remove(W.lastTh, "desc"), K.remove(W.lastTh, "asc")),
                (W.lastTh = ba),
                (Y = ca.concat(da)),
                (W.data = []);
            var ea = [];
            ...
            (X.activeRows = []),
                ...
                F(X.data, function (Z, $) {
                    (T = Z.cloneNode()),
                        ...
                        null !== Z.searchIndex && void 0 !== Z.searchIndex && (T.searchIndex = U.searchIndex = Z.searchIndex),
    ...
    return (
                ...
                setTimeout(function () {
                    U.emit("datatable.init"),
                        ...
                        F(U.options.plugins, function (V, W) {
                            U[W] && "function" == typeof U[W] && ((U[W] = U[W](V, { each: F, extend: E, classList: K, createElement: H })), V.enabled && U[W].init && "function" == typeof U[W].init && U[W].init());
                        });
                }, 10);
        }),
        (S.render = function (T) {
                        ...
                        if (4 === Y.readyState)
                            if ((U.emit("datatable.ajax.loaded", ia, Y), 200 === Y.status)) {
                                ...
                                (ja.data = X.load ? X.load.call(U, Y) : Y.responseText),
                                    (ja.type = "json"),
                                    X.content && X.content.type && ((ja.type = X.content.type), (ja = E(ja, X.content))),
                                    U.import(ja),
                                    U.setColumns(!0),
            ...
            if (
                ((U.headings = []),
                    ...
                    U.hasHeadings && ((U.header = U.head.rows[0]), (U.headings = [].slice.call(U.header.cells))),
                    !V.header && U.head && U.table.removeChild(U.table.tHead),
                    V.footer ? U.head && !U.foot && ((U.foot = H("tfoot", { html: U.head.innerHTML })), U.table.appendChild(U.foot)) : U.foot && U.table.removeChild(U.table.tFoot),
                    (U.wrapper = H("div", { class: "dataTable-wrapper dataTable-loading" })),
        ...
        (S.renderPage = function () {
            ...
            var Y,
                ...
                X = 0;
            if (
                (this.totalPages && ((V = this.currentPage - 1), (W = V * this.options.perPage), (X = W + this.pages[V].length), ++W, (Y = this.searching ? this.searchData.length : this.data.length)),
        ...
        (S.renderPager = function () {
            if ((I(this.pagers, this.isIE), 1 < this.totalPages)) {
                ...
                var X = this.links;
                this.options.truncatePager && (X = M(this.links, this.currentPage, this.pages.length, this.options.pagerDelta, this.options.ellipsisText)),
                    K.add(this.links[this.currentPage - 1], "active"),
                    F(X, function (Y) {
                        K.remove(Y, "active"), U.appendChild(Y);
                    }),
                    K.add(this.links[this.currentPage - 1], "active"),
                    this.options.nextPrev && U.appendChild(J(T, W, this.options.nextText)),
                    this.options.firstLast && U.appendChild(J(T, this.totalPages, this.options.lastText)),
                ...
                F(T.headings, function (U, V) {
                    if (
                        ((T.labels[V] = U.textContent),
                            K.contains(U.firstElementChild, "dataTable-sorter") && (U.innerHTML = U.firstElementChild.innerHTML),
                ...
                G(T.wrapper, "click", function (W) {
                    ...
                    "a" === X.nodeName.toLowerCase() &&
                        (X.hasAttribute("data-page")
                            ...
                            : U.sortable && K.contains(X, "dataTable-sorter") && "false" != X.parentNode.getAttribute("data-sortable") && (T.columns().sort(T.activeHeadings.indexOf(X.parentNode) + 1), W.preventDefault()));
                });
        }),
            ...
            T ||
                ...
                F(U.options.columns, function (V) {
                    C(V.select) || (V.select = [V.select]),
                        V.hasOwnProperty("render") && "function" == typeof V.render && ((U.selectedColumns = U.selectedColumns.concat(V.select)), U.columnRenderers.push({ columns: V.select, renderer: V.render })),
                        F(V.select, function (W) {
                            var X = U.headings[W];
                            V.type && X.setAttribute("data-type", V.type),
                                V.format && X.setAttribute("data-format", V.format),
                                V.hasOwnProperty("sortable") && X.setAttribute("data-sortable", V.sortable),
                                V.hasOwnProperty("hidden") && !1 !== V.hidden && U.columns().hide(W),
                                V.hasOwnProperty("sort") && 1 === V.select.length && U.columns().sort(V.select[0] + 1, V.sort, !0);
                        });
                }),
                U.hasRows &&
            ...
            return (
                ...
                T.length
                    ? void (this.clear(),
                        ...
                        U.searchData.length ? U.update() : (K.remove(U.wrapper, "search-results"), U.setMessage(U.options.labels.noRows)),
                        this.emit("datatable.search", T, this.searchData))
                    : ((this.searching = !1), this.update(), this.emit("datatable.search", T, this.searchData), K.remove(this.wrapper, "search-results"), !1)
            );
        }),
        (S.page = function (T) {
        ...
        (S.export = function (T) {
            ...
            var X,
                ...
                W = [];
            if (!B(T)) return !1;
            var aa = E({ download: !0, skipColumn: [], lineDelimiter: "\n", columnDelimiter: ",", tableName: "myTable", replacer: null, space: 4 }, T);
            if (aa.type) {
                ...
                else if (C(aa.selection)) for (X = 0; X < aa.selection.length; X++) V = V.concat(this.pages[aa.selection[X] - 1]);
                if (V.length) {
        ...
        (S.import = function (T) {
            ...
            if (((T = E({ lineDelimiter: "\n", columnDelimiter: "," }, T)), T.data.length || B(T.data))) {
                if ("csv" === T.type) {
                    ...
                    W.length &&
                        (T.headings && ((U.headings = W[0].split(T.columnDelimiter)), W.shift()),
                            F(W, function (Y, Z) {
                                U.data[Z] = [];
